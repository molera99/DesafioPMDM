...
class AdaptadorRanking(var pilotos: List<Piloto>, var context: Context) : RecyclerView.Adapter<AdaptadorRanking.ViewHolder>() {
    ...
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        val nombrePiloto = view.findViewById(R.id.txtPilotoCard) as TextView
        val foto=view.findViewById(R.id.ivPilotoCard) as ImageView
         ...
         */
        fun bind(pil:Piloto, context: Context, pos: Int, miAdaptadorRecycler: AdaptadorRanking){
                nombrePiloto.text=pil.nombre

                if(pil.foto!="Defecto"){
                    var fotoPiloto = BitmapFactory.decodeFile(pil.foto)
                    foto.setImageBitmap(fotoPiloto)
                }else{
                    val imageResource: Int = context.getResources().getIdentifier("@drawable/piloto", null, context.getPackageName())
            ...
            itemView.setOnClickListener(View.OnClickListener
            {
                if (pos == AdaptadorMisionSin.seleccionado){
                    ...
                    var intentDetalles = Intent(context, DetallesRankingActivity::class.java)
                    intentDetalles.putExtra("piloto",pil)
