...
class AdaptadorMisionAcab(var misiones : ArrayList<Mision>, var  context: Context) : RecyclerView.Adapter<AdaptadorMisionAcab.ViewHolder>() {
    ...
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
         ...
         */
        fun bind(mis:Mision, context: Context, pos: Int, miAdaptadorRecycler: AdaptadorMisionAcab){
            tipoMision.text = mis.tipo

            //Para marcar o desmarcar al seleccionado usamos el siguiente código.
            if (mis.resultado=="Fallido") {
                with(tipoMision) {
